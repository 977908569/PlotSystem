...
#define UE_PROJECT_NAME Plot
#define UE_TARGET_NAME PlotEditor
...
#define PLOTPLUGIN_API DLLIMPORT
#define KISMETWIDGETS_API DLLIMPORT
#define TOOLMENUS_API DLLIMPORT
#define PLOTPLUGINEDITOR_API DLLEXPORT
